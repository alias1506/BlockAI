...
public class RoadmapTask {
    ...
    private RoadmapTaskType status;
    ...
    public RoadmapTask(int id, String type, String description) {
        ...
        this.status = RoadmapTaskType.PENDING;
    }

    public int getId() { return id; }
    public String getType() { return type != null ? type : "unknown"; }
    public String getDescription() { return description != null ? description : ""; }
    public RoadmapTaskType getStatus() { return status == null ? RoadmapTaskType.PENDING : status; }

    public void setStatus(RoadmapTaskType status) {
        this.status = status;
    }
    ...
    public void setAllowsExcavation(boolean allowsExcavation) { this.allowsExcavation = allowsExcavation; }
    public boolean isProtectGround() { return protectGround; }
    public void setProtectGround(boolean protectGround) { this.protectGround = protectGround; }
